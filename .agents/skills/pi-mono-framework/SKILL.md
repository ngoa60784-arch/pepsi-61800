...
- **OAuth tokens trigger Codex impersonation** — `sk-ant-oat` prefix activates special headers, system prompt prefix, and tool name translation.
...
- **[references/pi-ai-internals.md](references/pi-ai-internals.md)** — Provider impl patterns, OAuth flows, Codex mode, adaptive thinking, cache retention, cost calculation, browser compat
